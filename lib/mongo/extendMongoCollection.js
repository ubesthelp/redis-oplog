...
export default () => {
  ...
  _.extend(proto, {
    ...
    // Override find to make pub/sub working without caching.
    // Otherwise, the fields will be ignored during pub/sub.
    find(selector, options) {
      if (options && options.fields) {
        options._fields = options.fields;
      }

      return Originals.find.call(this, selector, options);
    },
